export default class Balance {
  ...
  toJSON(): Record<string, number> {
    return this.initialized.reduce(
      (json, key) => ({ ...json, [key]: this.get(key) }),
      {}
    );
  }

  public addCHQ(value: number | null) {
    this.add("CHQ", value);
  }
  public addAutre(value: number | null) {
    this.add("autre", value);
  }
  public addReçu(value: number | null) {
    this.add("reçu", value);
  }
  public addTransaction(value: number | null) {
    this.add("transaction", value);
  }
  public addError(value: string | null) {
  ...
  public get CHQ(): number {
    return this.get("CHQ");
  }
  public get autre(): number {
    return this.get("autre");
  }
  public get reçu(): number {
  ...
  public hasCHQ(): boolean {
    return this.has("CHQ");
  }
  public hasAutre(): boolean {
    return this.has("autre");
  }
  public hasReçu(): boolean {
  ...
  private validKey(key: string): void | never {
    if (!["transaction", "CHQ", "autre", "reçu"].includes(key))
      throw new ReferenceError(
        `La balance ne possède pas de cumul pour "${key}"`
      );
  }
}
