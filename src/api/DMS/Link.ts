...
const proxyName = 'APIDMSLink';
let obj: any = null;
export class APIDMSLink {
  ...
  public static Parse(d: string): APIDMSLink {
    return APIDMSLink.Create(JSON.parse(d));
  }
  public static Create(d: any, field?: string, multiple ?: string): APIDMSLink {
    if (!field) {
      obj = d;
      field = "root";
    }
