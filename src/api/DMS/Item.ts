...
export class APIDMSItem {
  ...
  public readonly items?: ItemsEntityOrChildrenEntity[];
...
export class ChildrenEntityOrItemsEntity {
  ...
  public readonly updated_at: string;
  public readonly visible?: boolean;
  public static Parse(d: string): ChildrenEntityOrItemsEntity {
    return ChildrenEntityOrItemsEntity.Create(JSON.parse(d));
  }
  public static Create(d: any, field?: string, multiple ?: string): ChildrenEntityOrItemsEntity {
    if (!field) {
      obj = d;
      field = "root";
    }
...
export class ItemsEntityOrChildrenEntity {
  public readonly archived_at: null;
  public readonly comments_count?: number;
  public readonly created_at: string;
  public readonly creator: null | Creator2;
  public readonly favorite?: boolean;
  public readonly file_extension?: string;
  public readonly file_size?: number;
  public readonly file_url?: string;
  ...
  public readonly updated_at: string;
  public readonly visible?: boolean;
  public static Parse(d: string): ItemsEntityOrChildrenEntity {
    return ItemsEntityOrChildrenEntity.Create(JSON.parse(d));
  }
  public static Create(d: any, field?: string, multiple ?: string): ItemsEntityOrChildrenEntity {
    if (!field) {
      obj = d;
      field = "root";
    }
    ...
    // This will be refactored in the next release.
    try {
      checkNull(d.creator, field + ".creator", "null | Creator2");
    } catch (e) {
      try {
...
export class Creator2 {
  public readonly email: string;
  public readonly first_name: string;
  public readonly full_name: string;
  public readonly last_name: string;
  public readonly role: string;
  public static Parse(d: string): Creator2 {
    return Creator2.Create(JSON.parse(d));
  }
  public static Create(d: any, field?: string, multiple ?: string): Creator2 {
    if (!field) {
      obj = d;
      field = "root";
    }
