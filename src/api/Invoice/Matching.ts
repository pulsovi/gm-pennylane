...
const proxyName = 'APIInvoiceMatching';
let obj: any = null;
export class APIInvoiceMatching {
  ...
  public static Parse(d: string): APIInvoiceMatching {
    return APIInvoiceMatching.Create(JSON.parse(d));
  }
  public static Create(d: any, field?: string, multiple ?: string): APIInvoiceMatching {
    if (!field) {
      obj = d;
      field = "root";
    }
